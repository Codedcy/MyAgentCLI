...
- [ ] **Step 4: Implement config schema and validation**
...
- [ ] **Step 1: Write failing append and streaming tests**
...
- [ ] **Step 4: Implement transcript buffer**
...
- [ ] **Step 1: Write failing submit and multiline tests**
...
- [ ] **Step 2: Write failing control-key tests**
...
- [ ] **Step 3: Write failing input height tests**
...
- [ ] **Step 5: Implement input controller**
...
- [ ] **Step 2: Write failing output sink tests**
...
- [ ] **Step 3: Write failing scroll and refresh tests**
...
- [ ] **Step 4: Write failing lifecycle and fallback tests**
...
- [ ] **Step 6: Implement chat window controller**
...
- [ ] **Step 1: Write failing chat output tests**
...
- [ ] **Step 2: Write failing stream routing tests**
...
- [ ] **Step 3: Write failing prompt-loop split tests**
...
- [ ] **Step 4: Write failing ask-user tests**
...
- [ ] **Step 6: Implement REPL chat routing**
...
- [ ] **Step 3: Write failing fallback wiring test**
...
- [ ] **Step 1: Add no-second-Live regression test**
...
- [ ] **Step 2: Add Inspector compatibility tests**
...
- [x] README, spec status, full test suite, ruff, `--help`, `--list-sessions`, and manual smoke map to Task 9.
